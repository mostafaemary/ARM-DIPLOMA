...
void MRCC_voidEnableClock(void)
{
	...
	CLR_BIT(RCC_Pointer_Reg->RCC_CR, 0);
	CLR_BIT(RCC_Pointer_Reg->RCC_CR, 24);
...
void MRCC_voidInitSysClock(void)
{
	...
	MRCC_voidEnableClock();
	CLR_BIT(RCC_Pointer_Reg->RCC_CFGR, 0);
	CLR_BIT(RCC_Pointer_Reg->RCC_CFGR, 1);

	CLR_BIT(RCC_Pointer_Reg->RCC_CFGR, 4);
	CLR_BIT(RCC_Pointer_Reg->RCC_CFGR, 5);
	CLR_BIT(RCC_Pointer_Reg->RCC_CFGR, 6);
	SET_BIT(RCC_Pointer_Reg->RCC_CFGR, 7);
